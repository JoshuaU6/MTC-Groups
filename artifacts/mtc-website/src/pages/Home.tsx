          ...
          <ScrollReveal>
            <div className="flex flex-col md:flex-row justify-between items-end mb-16">
              ...
              <Link href="/sectors" className="hidden md:flex items-center text-mtc-red font-semibold hover:text-red-800 transition-colors">
                View All Sectors <ChevronRight className="w-5 h-5 ml-1" aria-hidden="true" />
              </Link>
            </div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <ScrollReveal key={sector.title} delay={i * 100}>
                <div className="group cursor-pointer bg-white p-8 shadow-sm hover:shadow-xl transition-all duration-300 border-l-4 border-transparent hover:border-mtc-red h-full">
        ...
        <ScrollReveal className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Link href="/contact">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-mtc-red hover:bg-red-800 text-white rounded px-8 py-6 text-lg"
                aria-label="Contact MTC Group to discuss partnership opportunities"
              >
                Contact Us
              </Button>
            </Link>
            <Link href="/global-presence">
              <Button
                variant="outline"
                size="lg"
                className="w-full sm:w-auto bg-transparent text-white border-white hover:bg-white hover:text-mtc-charcoal rounded px-8 py-6 text-lg"
                aria-label="View MTC Group global office locations"
              >
                Global Offices
              </Button>
            </Link>
